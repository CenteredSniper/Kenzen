...
Last Modified: 12/17/2021 10:54PM
Author: ???
...
local animationslist = game:GetObjects("rbxassetid://8278088356")[1] --7979526466")[1] --7948728902")[1] --7113399253")[1]
for i,v in pairs(animationslist:GetChildren()) do
	spawn(function()
		local newbutton = dummy:Clone()
		newbutton.Text = v.Name 
		newbutton.Name = v.Value
