...
Last Modified: 2/20/2022 5:01AM
Author: Me

--]]

--[[
    Required: <ids: 11679229,11142504,5802033534
    https://www.roblox.com/catalog/11679229/Motocross-62-Fire
    https://www.roblox.com/catalog/11142504/Motocross-48-Old-Skool
    https://www.roblox.com/catalog/5802033534/Smiling-Mask-Of-Sorrow

    Optional: 
    https://www.roblox.com/catalog/8239816187/Skull-Kid
    https://www.roblox.com/catalog/8239816865/Skull-Kid-Pants
    https://www.roblox.com/catalog/13121508/Frumpled-Wizard-Hat-of-Old-Coots
...
Character["Dripping Mask"].Handle.AccessoryWeld:Destroy()
Character["Dripping Mask"].Handle.Anchored = true

--Character["Metashard"].Handle.AccessoryWeld:Destroy()
--Character["Metashard"].Handle.Anchored = true

Character["Racing Helmet"].Handle.AccessoryWeld:Destroy()
Character["Racing Helmet"].Handle.Anchored = true
Character["Racing Helmet"].Handle.Transparency = 1
Character[Player.Name]["Racing Helmet"].Handle.Mesh:Destroy()

Character["Racing Helmet Flames"].Handle.AccessoryWeld:Destroy()
Character["Racing Helmet Flames"].Handle.Anchored = true
Character["Racing Helmet Flames"].Handle.Transparency = 1
Character[Player.Name]["Racing Helmet Flames"].Handle.Mesh:Destroy()
...
game["Run Service"].Heartbeat:Connect(function()
    if Head:FindFirstChild("Majora's Decoy") then
		Character["Dripping Mask"].Handle.CFrame = Head:FindFirstChild("Majora's Decoy").CFrame-- * CFrame.Angles(0,math.rad(90),0)
	else
		Character["Dripping Mask"].Handle.CFrame = Mask.CFrame * CFrame.Angles(math.rad(-90),0,math.rad(180))
	end
	Character["Racing Helmet"].Handle.CFrame = Tael.CFrame
	Character["Racing Helmet Flames"].Handle.CFrame = Tatl.CFrame
end)

while task.wait(1/60) do
	--Character["Metashard"].Handle.CFrame = Ocarina.CFrame
