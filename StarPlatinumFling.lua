...
local Hats = {rightarm = Character:WaitForChild("Hat1").Handle,
	leftarm  = Character:WaitForChild("Pal Hair").Handle,
	rightleg = Character:WaitForChild("LavanderHair").Handle,
	leftleg  = Character:WaitForChild("Pink Hair").Handle,
	head   = Character:FindFirstChild("Dummy_Head").Handle,
	torso = Character:WaitForChild("SeeMonkey").Handle
}
local Stand = Instance.new("Model",Character)
Stand.Name = "Stand"
local ST = Instance.new("Part",Stand) -- Torso
...
Hats.torso.AccessoryWeld.Part1 = ST
Hats.torso.AccessoryWeld.C1 = CFrame.new()
Hats.torso.AccessoryWeld.C0 = CFrame.Angles(math.rad(-90),0,0)
Hats.torso:FindFirstChildOfClass("SpecialMesh"):Destroy()
getgenv().RealRig[Hats.torso.Parent.Name].Handle:FindFirstChildOfClass("SpecialMesh"):Destroy()

local SH = Instance.new("Part",Stand) -- Head
...
Hats.head.AccessoryWeld.Part1 = SH
Hats.head.AccessoryWeld.C1 = CFrame.new()
Hats.head.AccessoryWeld.C0 = CFrame.new()

if Character:FindFirstChild("Meshes/LimitBreakingHairBlackAccessory") then
	local hair = Character["Meshes/LimitBreakingHairBlackAccessory"]
	hair.Handle.AccessoryWeld.Part1 = SH
end
if Character:FindFirstChild("Gold_Tiara_Crown") then
	local hair = Character["Gold_Tiara_Crown"]
	hair.Handle.AccessoryWeld.Part1 = SH
end

local SRA = Instance.new("Part",Stand) -- Right Arm
...
Hats.rightarm.AccessoryWeld.Part1 = SRA
Hats.rightarm.AccessoryWeld.C1 = CFrame.new()
Hats.rightarm.AccessoryWeld.C0 = CFrame.Angles(math.rad(90),0,0)
Hats.rightarm:FindFirstChildOfClass("SpecialMesh"):Destroy()
print(getgenv().RealRig[Hats.rightarm.Parent.Name])
getgenv().RealRig[Hats.rightarm.Parent.Name].Handle:FindFirstChildOfClass("SpecialMesh"):Destroy()

local SLA = Instance.new("Part",Stand) -- Left Arm
...
Hats.leftarm.AccessoryWeld.Part1 = SLA
Hats.leftarm.AccessoryWeld.C1 = CFrame.new()
Hats.leftarm.AccessoryWeld.C0 = CFrame.Angles(math.rad(90),0,0)
Hats.leftarm:FindFirstChildOfClass("SpecialMesh"):Destroy()
getgenv().RealRig[Hats.leftarm.Parent.Name].Handle:FindFirstChildOfClass("SpecialMesh"):Destroy()

local SRL = Instance.new("Part",Stand) -- Right Leg
...
Hats.rightleg.AccessoryWeld.Part1 = SRL
Hats.rightleg.AccessoryWeld.C1 = CFrame.new()
Hats.rightleg.AccessoryWeld.C0 = CFrame.Angles(math.rad(90),0,0)
Hats.rightleg:FindFirstChildOfClass("SpecialMesh"):Destroy()
getgenv().RealRig[Hats.rightleg.Parent.Name].Handle:FindFirstChildOfClass("SpecialMesh"):Destroy()

local SLL = Instance.new("Part",Stand) -- Left Leg
...
Hats.leftleg.AccessoryWeld.Part1 = SLL
Hats.leftleg.AccessoryWeld.C1 = CFrame.new()
Hats.leftleg.AccessoryWeld.C0 = CFrame.Angles(math.rad(90),0,0)
Hats.leftleg:FindFirstChildOfClass("SpecialMesh"):Destroy()
getgenv().RealRig[Hats.leftleg.Parent.Name].Handle:FindFirstChildOfClass("SpecialMesh"):Destroy()
...
function Blast()
	if D == false then 
		...
		Bl.Touched:connect(function(hit)
			if hit.Parent:FindFirstChild("Humanoid") and hit.Parent ~= nil and hit.Parent.Name ~= getgenv().CloneRig and hit.Parent ~= getgenv().RealRig then
				Bl:remove()
...
function StrongOra()
	if D == false then 
		...
		HB.Touched:connect(function(hit)
			if hit.Parent:FindFirstChild("Humanoid") and hit.Parent ~= nil and hit.Parent.Name ~= getgenv().CloneRig and hit.Parent ~= getgenv().RealRig then
				getgenv().RealRig.HumanoidRootPart.BodyAngularVelocity.AngularVelocity = Vector3.new(5000000,5000000,5000000)
				HB:remove()
				local Ef = Instance.new("Part",workspace)
				Ef.Size = Vector3.new(1,1,1)
				Ef.CanCollide = false
		...
		Pause = false
		getgenv().RealRig.HumanoidRootPart.BodyAngularVelocity.AngularVelocity = Vector3.new(0,0,0)
		wait(0.5)
		D = false
	end
end
...
coroutine.wrap(function()
	--getgenv().RealRig.HumanoidRootPart.BodyAngularVelocity.AngularVelocity = Vector3.new(5000000,5000000,5000000)
	local selectionbox = Instance.new("SelectionBox",getgenv().RealRig.HumanoidRootPart)
	selectionbox.Adornee = getgenv().RealRig.HumanoidRootPart; selectionbox.SurfaceColor3 = Color3.new(255,0,0); selectionbox.Transparency = 1; selectionbox.SurfaceTransparency = 0.8
	getgenv().RealRig.HumanoidRootPart.Size = SRA.Size
	while getgenv().RealRig and task.wait() do
		getgenv().RealRig.HumanoidRootPart.CFrame = SRA.CFrame
	end
end)()
Stand()
while true do
