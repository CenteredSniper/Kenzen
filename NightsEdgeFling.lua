...
local flingpart = getgenv().RealRig.HumanoidRootPart
--flingpart.BodyAngularVelocity.AngularVelocity = Vector3.new(2147483646,2147483646,2147483646)
...
coroutine.wrap(function()
	...
	--flingpart.Size = Char["Back_AccAccessory"].Handle.Size
	--flingpart.Size = SW.Blade.Size
	local selectionbox = Instance.new("SelectionBox",flingpart)
	selectionbox.Adornee = flingpart; selectionbox.SurfaceColor3 = Color3.new(0,255,0); selectionbox.Transparency = 1; selectionbox.SurfaceTransparency = 0.8; selectionbox.Name = "FlingSelection"
	while getgenv().RealRig and task.wait() do
		flingpart.CFrame = Char["Back_AccAccessory"].Handle.CFrame
	end
end)()
...
game:GetService("UserInputService").InputBegan:Connect(function(IO,L)
	...
	elseif IO.UserInputType==Enum.UserInputType.MouseButton1 then
		...
		flingpart.BodyAngularVelocity.AngularVelocity = Vector3.new(2147483646,2147483646,2147483646)
		flingpart.FlingSelection.SurfaceColor3 = Color3.new(1,0,0)
		Combos[Combo]()
		Combo=Combo+1
		if Combo>#Combos then Combo=1 end
		task.wait(0.5)
		if not Using then
			flingpart.BodyAngularVelocity.AngularVelocity = Vector3.new(0,0,0)
			flingpart.FlingSelection.SurfaceColor3 = Color3.new(0,1,0)
		end
	end
end)
